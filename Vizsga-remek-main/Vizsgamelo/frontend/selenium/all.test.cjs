...
async function runTests() {
    ...
    try {
        ...
        await driver.get('http://localhost:5173/turak');
        await driver.sleep(2000);
        ...
        await driver.get('http://localhost:5173/berles');
        await driver.sleep(2000);
        ...
        await driver.get('http://localhost:5173/galeria');
        await driver.sleep(2000);
        ...
        await driver.get('http://localhost:5173/profil');
        await driver.sleep(2000);
        ...
        await driver.get('http://localhost:5173/foglalas');
        await driver.sleep(2000);
        ...
        await driver.get('http://localhost:5173/fizetes');
        await driver.sleep(2000);
        ...
        await driver.get('http://localhost:5173/helyszinek-terkep');
        await driver.sleep(2000);
        ...
        await driver.get('http://localhost:5173/impresszum');
        await driver.sleep(2000);
